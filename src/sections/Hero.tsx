...
export const Hero = () => {
  return (
    ...
    >
      ...
      <div className=" absolute h-[344px] w-[344px] md:w-[580px] md:h-[580px] opacity-20 border-white  rounded-full border top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <div className=" absolute h-[544px] w-[544px] md:w-[980px] md:h-[980px] rounded-full border border-white/20   top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
